...
public class _ServerInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements Server.ServerInterface
{
  ...
  public boolean createSRecord (String managerID, String firstName, String lastName, String courseRegisted, String status, String statusDate)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $out.write_string (firstName);
                $out.write_string (lastName);
                $out.write_string (courseRegisted);
                ...
                return createSRecord (managerID, firstName, lastName, courseRegisted, status, statusDate        );
            } finally {
                _releaseReply ($in);
            }
  } // createSRecord
